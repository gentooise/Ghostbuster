...
\myfig{fig:plc_io} shows the results of our reverse engineering analysis on Wago PLC, outlining the main control flow executed during each I/O operation.
...
To conclude our PLC analysis, we developed the IRQ DoS attack in two different variants: kernel side and user side.
