...
A simplified version of the environment in which a PLC may operate is outlined in \myfig{fig:plc_env}.
\begin{figure}[h]
...
The PLC main scan cycle is shown in \myfig{fig:scan_cycle}.
\begin{figure}[h]
...
\mychap{chap:attack} contains, after a brief description of the embedded systems architecture, a detailed analysis of Pin Control Attack design and implementation.
In \mychap{chap:defense} we present the architecture of our proposed Pin Control Defense, then we describe the implementation and provide developer and user manual for it.
